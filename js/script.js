...
$(function() {
    $('#toggle .content').hide();
    $('#toggle h3:first').addClass('active').next().slideDown(300);
    $('#toggle h3').click(function() {
        if($(this).next().is(':hidden')) {
            $('#toggle h3').removeClass('active').next().slideUp(300);
...
/*** TEAM ***/	
	var team = $('.team-carousel .team .member');
	$(team).click(function(e){
		$(this).parent().find('.member').removeClass('active');
...
if ($(window).width() < 980) {
 ...
 $('nav').removeClass('respsonsive-menu');
}	
	...
	$('.fixed-bottom').click(function(){
		$('nav').addClass('stick-bottom');
	});	
	

/*** FIXED SIDEMENU APPEARS ON SCROLL DOWN ***/	
$(window).scroll(function() {    
	var scroll = $(window).scrollTop();
	if (scroll >= 50) {
		$("nav").addClass("sticky animated bounceInDown");
		$("nav").removeClass("bounceInUp");
	}
	else{
		$("nav").removeClass("sticky animated bounceInDown");
...
$(window).scroll(function() {    
	...
	if (scroll2 >= 50) {
		$("nav.hide-menu").addClass("show-menu  animated bounceInUp");
	}
	else{
		$("nav.hide-menu").removeClass("show-menu  animated bounceInUp");
	}
});	
...
function thirty_pc() {
    ...
    $(".text-slider").css('height',thirtypc);
}
...
$(window).scroll(function() {    
	var scroll = $(window).scrollTop();
	if (scroll >= 50) {
		$(".stick-header").addClass("sticky");
	}
	else{
		$(".stick-header").removeClass("sticky");
	}
});
